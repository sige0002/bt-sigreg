...
def main():
    ...
    launch = {'upstream_commit': COMMIT, 'checkpoint': str(checkpoint), 'checkpoint_sha256': file_sha256(checkpoint),
              'upstream_eval_sha256': file_sha256(source / 'eval.py'), 'seed': args.seed,
    ...
    def audited(self, *a, **kw):
        ...
        result.update(checkpoint_sha256=file_sha256(checkpoint), episodes=episodes, starts=starts)
