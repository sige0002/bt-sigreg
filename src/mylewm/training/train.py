...
from mylewm.algorithms.bt_sigreg import BoundedTransport, add_bt_arguments
from mylewm.data.verification import file_sha256, verify_training_data
from mylewm.training.state import capture_rng, restore_rng, tensor_state_hash
...
def clip_dataset(manifest):
    ...
    if data_format == 'lerobot':
        from mylewm.data.lerobot_data import LeRobotClips
