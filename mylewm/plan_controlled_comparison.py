...
def plan(seed=3072,steps=50000,methods=('raw','rbg')):
    ...
    return {'schema':'controlled_comparison_plan_v2','dry_run':True,'benchmark':'pusht',
        ...
        'official_first':[sys.executable,str(ROOT/'mylewm/evaluate_official_pusht.py'),'--execute'],
        'shared_initialization':[sys.executable,str(ROOT/'mylewm/create_shared_initialization.py'),
