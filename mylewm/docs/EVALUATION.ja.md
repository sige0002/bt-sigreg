...
**再生成256pxデータの新しいモデルを評価する前に、描画解像度の対応が必要です。** 現行BC評価器の環境生成は128×128固定です。旧128pxモデルの評価経路は検証済みですが、学習用256px画像を224pxへ縮小する新モデルと同じ条件であるとは扱えません。新データ用の256px評価・画像監査は別途整備してから実行してください。
