...
|---|---|---|
| Raw／BT clip90・各140k | 同条件50ケース：20kはRaw32／BT42成功、40kはRaw38／BT42成功、60kはRaw46／BT45成功。60kの4探索seed平均はRaw88.5%／BT85.5%。[記録](PUSHT_RAW_BT_140K.ja.md) | 同初期値・同予算の途中比較。14万更新完了と最終制御成績は未確認 |
